-- Migration: Fix continue watching images for episodes
-- Description: Update get_continue_watching function to use episode images instead of series images
...
AS $$
  ...
  LEFT JOIN public.jellyfin_episodes je ON je.jellyfin_id = ci.jellyfin_id 
