...
class JellyfinClient {
  ...
  async findEpisode(seriesJellyfinId: string, seasonNumber: number, episodeNumber: number) {
    ...
    const url = `${this.baseUrl}/Shows/${seriesJellyfinId}/Episodes?season=${seasonNumber}&userId=${this.userId}&fields=MediaSources`;
...
serve(async (req) => {
  ...
  try {
    ...
    if (seriesJellyfinId === undefined || seasonNumber === undefined || episodeNumber === undefined) {
