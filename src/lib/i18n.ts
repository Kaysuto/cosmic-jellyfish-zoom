...
const resources = {
  fr: {
    translation: {
      ...
      "available_tv_shows": "Séries TV disponibles",
      "available_animes": "Animés disponibles",
      "view_all": "Voir tout",
      "movies": "Films",
      "tv_shows": "Séries",
      "animes": "Animés",
  ...
  en: {
    translation: {
      ...
      "available_tv_shows": "Available TV Shows",
      "available_animes": "Available Anime",
      "view_all": "View all",
      "movies": "Movies",
      "tv_shows": "TV Shows",
      "animes": "Anime",
