...
const resources = {
  fr: {
    translation: {
      ...
      "hero_title": "Votre univers de divertissement, unifié.",
      "hero_subtitle": "Explorez, demandez et suivez le statut de vos services de streaming préférés. Rejoignez une communauté passionnée et ne manquez plus jamais rien.",
      "cta_status": "Voir le statut des services",
      "cta_requests": "Faire une demande",
      "features_title": "Une expérience centralisée",
      "feature_1_title": "Statut en temps réel",
      "feature_1_desc": "Gardez un œil sur la disponibilité de tous nos services avec des mises à jour en direct et un historique de performance.",
      "feature_2_title": "Demandes faciles",
      "feature_2_desc": "Vous ne trouvez pas ce que vous cherchez ? Soumettez une demande de film ou de série en quelques clics et suivez son statut.",
      "feature_3_title": "Communauté active",
      "feature_3_desc": "Échangez avec d'autres membres, découvrez de nouveaux contenus et participez à la vie de notre communauté sur Discord.",
  ...
  en: {
    translation: {
      ...
      "hero_title": "Your entertainment universe, unified.",
      "hero_subtitle": "Explore, request, and track the status of your favorite streaming services. Join a passionate community and never miss a thing.",
      "cta_status": "View Services Status",
      "cta_requests": "Make a Request",
      "features_title": "A Centralized Experience",
      "feature_1_title": "Real-Time Status",
      "feature_1_desc": "Keep an eye on the availability of all our services with live updates and performance history.",
      "feature_2_title": "Easy Requests",
      "feature_2_desc": "Can't find what you're looking for? Submit a movie or series request in just a few clicks and track its status.",
      "feature_3_title": "Active Community",
      "feature_3_desc": "Connect with other members, discover new content, and participate in our community life on Discord.",
