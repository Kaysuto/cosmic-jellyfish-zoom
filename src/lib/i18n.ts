...
const resources = {
  fr: {
    translation: {
      ...
      "webhook_headers_desc": "Ajoutez cet en-tête dans les paramètres de votre webhook pour l'authentification. C'est une étape obligatoire.",
  ...
  en: {
    translation: {
      ...
      "webhook_headers_desc": "Add this header in your webhook settings for authentication. This is a required step.",
