...
import { Settings, LogOut, Server, ShieldAlert, CheckCircle, Clock, BarChart2 } from 'lucide-react';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';
import { useServices } from '@/hooks/useServices';
import { useIncidents } from '@/hooks/useIncidents';
import { Skeleton } from '@/components/ui/skeleton';
import { differenceInMinutes } from 'date-fns';
import IncidentsByStatusChart from '../components/admin/charts/IncidentsByStatusChart';
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <Tabs defaultValue="analytics" className="w-full">
        <TabsList className="grid w-full grid-cols-5">
          <TabsTrigger value="analytics"><BarChart2 className="mr-2 h-4 w-4" />{t('analytics')}</TabsTrigger>
