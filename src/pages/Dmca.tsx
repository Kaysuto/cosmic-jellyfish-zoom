...
const DmcaPage = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-16">
      ...
      >
        <h1 className="text-4xl font-bold mb-6">Politique DMCA</h1>
        <div className="prose prose-invert prose-lg max-w-none text-muted-foreground space-y-6">
          <p>
            Le projet Jelly respecte la propriété intellectuelle d'autrui et attend de ses utilisateurs qu'ils fassent de même. Conformément au Digital Millennium Copyright Act (DMCA), nous répondrons rapidement aux réclamations pour violation de droits d'auteur commise via notre service.
          </p>
          
          <h2 className="text-2xl font-semibold text-white">Avis important</h2>
          <p>
            Notre plateforme fonctionne comme un index et une base de données de contenu disponible publiquement sur Internet, agissant de manière similaire à Google. Nous ne stockons ni n'hébergeons aucun fichier vidéo ou média sur nos serveurs. Notre service se contente de cataloguer les métadonnées et de fournir des liens vers des contenus hébergés par des tiers. Nous n'avons aucun contrôle sur ces services tiers.
          </p>

          <h2 className="text-2xl font-semibold text-white">Notification de violation de droits d'auteur</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-white">Où envoyer la notification ?</h2>
          <p>
            Veuillez envoyer votre notification de violation de droits d'auteur à notre agent désigné à l'adresse suivante :
          </p>
          <p>
            <strong>E-mail :</strong> <a href="mailto:contact@playjelly.fr" className="text-blue-400 hover:underline">contact@playjelly.fr</a>
          </p>
          <p>
